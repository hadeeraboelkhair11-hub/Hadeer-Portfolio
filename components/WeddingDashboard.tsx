...
function InvitationEditor({ id }: { id?: string }) {
  ...
  return <Shell active="invitations">
    ...
    <form className="wd-editor" onSubmit={(e)=>submit(e,'draft')}>
      ...
      <div className="wd-form-footer"><button type="button" className="wd-secondary" onClick={()=>navigate('/wedding-admin')}>إلغاء</button><button className="wd-primary" type="submit"><Save size={17}/> حفظ الدعوة</button></div>
    </form>
  </Shell>;
}
